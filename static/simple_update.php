<?php
/**
 * Simplified curling data update endpoint - in root curling directory
 * This avoids potential /api/ directory PHP execution issues
 */
...
// Extract current_end if not at top level
